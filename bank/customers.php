...
<meta name="keywords" content="the sparks foundation internship certificate, donation, the sparks foundation internship, grip at the sparks foundation, grip at the sparks foundation internship, the sparks foundation grip, the sparks foundation github, the sparks foundation internship web development, the sparks foundation internship, the sparks foundation linkedin, the sparks foundation network, the sparks foundation singapore, the sparks foundation tasks, the sparks foundation web development internship, hab, hab at grip, grip, hab grip, Graduate Rotational Internship Program, Payment gateway integration, task Payment gateway integration">
<meta name="author" content="ROHITH TR">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<script src="https://kit.fontawesome.com/030c849e74.js" crossorigin="anonymous"></script>
<link rel = "icon" href ="images/logo.png" type = "image/x-icon">
<title>Customer | Bank-HAB</title>
<style>
body {
margin:0;
padding:0;
...
.fixed-header {
background-color: rgb(128, 240, 221);
height: 50px;
line-height: 45px;
width: 100%;
text-align: center;
...
<section class="page-header">
    <div class="header">
        <div class="header-left"> 
            <img src="images/banklogo1.jpeg" class="header-left-logo">
        </div>    
...
<section class="page-footer">
    <footer class="footer-distributed">
        <div class="footer-left">
            <h2>Bank of <span>HAB</span></h2>
            <img src="images/banklogo1.jpeg">
    ...
    <div class="footer-bottom">
        <p class="footer-content">Designed & Developed with <i  style="color: rgb(128, 240, 221);"></i> by <a href="devloper.html">ROHITH TR</a></p>
    </div>
</section>
</body>
</html> 
